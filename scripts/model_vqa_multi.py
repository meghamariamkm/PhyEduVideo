...
base_path = 'PC-2/NEW/multiimage_clips1'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="PC-2/llava-interleave-qwen-7b-dpo-hf")
    ...
    modelnames = ['CogVideoX', 'Wan2.1', 'VideoCrafter2', 'phyt2v', 'Video-MSG']
    ...
    for modelname in modelnames:
        ...
        with open(f'Results/PC-2/NEW/{modelname}/prompt_replace_augment_multi_question_{modelname}_res_imageclip.json','r') as f:
            data = json.load(f)
        video_directory = os.path.join(directory,modelname)
        for i in range(len(data)):
            print(f'This is data[i]: {data[i]}')
            ...
            print(f'\n\nPrompts: Q1: {question_prompt1}\n Q2: {question_prompt2}, Q3: {question_prompt3}')
            ...
            all_exist = all(os.path.exists(path) for path in [output_first_image_path, output_middle_image_path, output_last_image_path])

            print("All files exist:" if all_exist else "Some files are missing.")
            print("First image:", os.path.exists(output_first_image_path))
            print("Middle image:", os.path.exists(output_middle_image_path))
            print("Last image:", os.path.exists(output_last_image_path))
        ...
        print(len(result))
        with open(f'Results/PC-2/NEW/{modelname}/prompt_replace_augment_multi_question_{modelname}_res_llava.json','w') as f:
